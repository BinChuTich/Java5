...
<form:form modelAttribute="nhanVien" action="/nhanvien/suanhanvien/${nhanVien.id}" method="post">
    ...
    <div>
        ...
        <form:radiobutton path="gioi_tinh" id="contacChoice3" value="Nu"></form:radiobutton>
